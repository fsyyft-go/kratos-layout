...
const file_internal_pkg_conf_config_proto_rawDesc = "" +
	"\n" +
	"\x1einternal/pkg/conf/config.proto\x12\rinternal.conf\x1a\x1egoogle/protobuf/duration.proto\"]\n" +
	"\x06Config\x12$\n" +
	...
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeoutB;Z9github.com/fsyyft-go/kratos-layout/internal/pkg/conf;confb\x06proto3"
...
var file_internal_pkg_conf_config_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
